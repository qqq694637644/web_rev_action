...
inspectBrowserEvidence 只读，用于查询 session、experiment 和 stream 状态。runBrowserExperiment 用于 open_session、capture_baseline、capture_flow、close_session 和 cancel_experiment，会执行页面操作或取消活动任务并触发确认。
